...
export const GAME_DETAILS: Record<string, any> = {
  ...
  'sosial-media': {
    ...
    items: [
      // Instagram Followers
      { id: 1, name: '100 Instagram Followers', price: 'Rp 6.500' },
      { id: 2, name: '200 Instagram Followers', price: 'Rp 10.000' },
      { id: 3, name: '300 Instagram Followers', price: 'Rp 14.500' },
      { id: 4, name: '400 Instagram Followers', price: 'Rp 18.000' },
      { id: 5, name: '500 Instagram Followers', price: 'Rp 22.000' },
      { id: 6, name: '600 Instagram Followers', price: 'Rp 25.000' },
      { id: 7, name: '700 Instagram Followers', price: 'Rp 28.000' },
      { id: 8, name: '800 Instagram Followers', price: 'Rp 31.000' },
      { id: 9, name: '900 Instagram Followers', price: 'Rp 34.000' },
      { id: 10, name: '1000 Instagram Followers', price: 'Rp 37.000' },
      
      // TikTok Followers
      { id: 11, name: '100 TikTok Followers', price: 'Rp 6.000' },
      { id: 12, name: '200 TikTok Followers', price: 'Rp 10.000' },
      { id: 13, name: '300 TikTok Followers', price: 'Rp 14.000' },
      { id: 14, name: '400 TikTok Followers', price: 'Rp 16.000' }, // Sebelumnya 16.000 + 2.000 -> Rp 18.000
      { id: 14, name: '400 TikTok Followers', price: 'Rp 18.000' },
      { id: 15, name: '500 TikTok Followers', price: 'Rp 22.000' },
      { id: 16, name: '600 TikTok Followers', price: 'Rp 26.000' },
      { id: 17, name: '700 TikTok Followers', price: 'Rp 30.000' },
      { id: 18, name: '800 TikTok Followers', price: 'Rp 34.000' },
      { id: 19, name: '900 TikTok Followers', price: 'Rp 37.000' },
      { id: 20, name: '1000 TikTok Followers', price: 'Rp 40.000' },

      // Instagram Likes
      { id: 21, name: '100 Instagram Likes', price: 'Rp 3.500' },
      { id: 22, name: '200 Instagram Likes', price: 'Rp 5.000' },
      { id: 23, name: '300 Instagram Likes', price: 'Rp 6.500' },
      { id: 24, name: '400 Instagram Likes', price: 'Rp 8.000' },
      { id: 25, name: '500 Instagram Likes', price: 'Rp 9.500' },
      { id: 26, name: '600 Instagram Likes', price: 'Rp 11.000' },
      { id: 27, name: '700 Instagram Likes', price: 'Rp 12.500' },
      { id: 28, name: '800 Instagram Likes', price: 'Rp 14.000' },
      { id: 29, name: '900 Instagram Likes', price: 'Rp 15.000' },
      { id: 30, name: '1000 Instagram Likes', price: 'Rp 16.000' },

      // TikTok Likes
      { id: 31, name: '100 TikTok Likes', price: 'Rp 4.000' },
      { id: 32, name: '200 TikTok Likes', price: 'Rp 6.000' },
      { id: 33, name: '300 TikTok Likes', price: 'Rp 8.000' },
      { id: 34, name: '400 TikTok Likes', price: 'Rp 10.000' },
      { id: 35, name: '500 TikTok Likes', price: 'Rp 12.000' },
      { id: 36, name: '600 TikTok Likes', price: 'Rp 13.000' },
      { id: 37, name: '700 TikTok Likes', price: 'Rp 14.000' },
      { id: 38, name: '800 TikTok Likes', price: 'Rp 15.000' },
      { id: 39, name: '900 TikTok Likes', price: 'Rp 16.000' },
      { id: 40, name: '1000 TikTok Likes', price: 'Rp 17.000' },
    ],
    fields: [
